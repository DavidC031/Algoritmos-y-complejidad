...
public class ClosePairsDivideAndConquer {
    ...
    public static void start() {
        int tamaño = 10;
        Point[] Puntos = new Point[tamaño];
        randomPoints(Puntos, tamaño);
        System.out.println("la distancia mas cercana es " + closest(Puntos));
    }

    public static void randomPoints(Point[] p, int n) {
        if (n != 0) {
