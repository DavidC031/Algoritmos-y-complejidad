...
public class ClosePairsDivideAndConquer {
    ...
    private static double stripClosest(Point[] strip, double d) {
        ...
        for (int k = 0; k != runs; k++) {
            ...
            double temp = (tfinal - tinicial) / 1e6;
            etimes[k] = temp;
    ...
    private static void export(double stats[][]) // exports the elapsed-time and #operations with respect to size
    {
        try {
